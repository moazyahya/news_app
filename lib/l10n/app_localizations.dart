...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'Hello Here is Some News For You'**
  String get hello;
  ...
  /// No description provided for @noArticsls.
  ///
  /// In en, this message translates to:
  /// **'No Articsls'**
  String get noArticsls;

  /// No description provided for @weekNetworkConnection.
  ///
  /// In en, this message translates to:
  /// **'Weak Network Connection!'**
  String get weekNetworkConnection;
